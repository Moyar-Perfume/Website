...
export default function BrandPage() {
  ...
  return (
    <main>
      {/* Banner Section */}
      <section className="bg-black w-full flex items-center justify-center min-h-screen pt-[132px]">
        <p className="absolute inset-0 z-20 text-white flex items-center justify-center text-2xl font-gotu text-center flex-col gap-4 pt-[132px]">
